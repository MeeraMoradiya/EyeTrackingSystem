...
class GazeTracking(object):
    ...
    def frame_left_coords(self, frame):
        ...
        center_top = ((facial_landmarks.part(eye_points[1]).x+facial_landmarks.part(eye_points[2]).x)/2, (facial_landmarks.part(eye_points[1]).y+facial_landmarks.part(eye_points[2]).y)/2)
