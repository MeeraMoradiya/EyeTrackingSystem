...
# Keyboard settings
keyboard = np.zeros((600, 2000, 3), np.uint8)
...
def letter(letter_index_i, letter_index_j, text, letter_light):
    ...
    elif letter_index_i == 0 and letter_index_j == 5:
        x = 1000
        y = 0
    elif letter_index_i == 0 and letter_index_j == 6:
        x = 1200
        y = 0
    elif letter_index_i == 0 and letter_index_j == 7:
        x = 1400
        y = 0
    elif letter_index_i == 0 and letter_index_j == 8:
        x = 1600
        y = 0
    elif letter_index_i == 0 and letter_index_j == 9:
        x = 1800
        y = 0
    ...
    elif letter_index_i == 1 and letter_index_j == 5:
        x = 1000
        y = 200
    elif letter_index_i == 1 and letter_index_j == 6:
        x = 1200
        y = 200
    elif letter_index_i == 1 and letter_index_j == 7:
        x = 1400
        y = 200
    elif letter_index_i == 1 and letter_index_j == 8:
        x = 1600
        y = 200
    elif letter_index_i == 1 and letter_index_j == 9:
        x = 1800
        y = 200
    ...
    elif letter_index_i == 2 and letter_index_j == 5:
        x = 1000
        y = 400
    elif letter_index_i == 2 and letter_index_j == 6:
        x = 1200
        y = 400
    elif letter_index_i == 2 and letter_index_j == 7:
        x = 1400
        y = 400
    elif letter_index_i == 2 and letter_index_j == 8:
        x = 1600
        y = 400
    elif letter_index_i == 2 and letter_index_j == 9:
        x = 1800
        y = 400
